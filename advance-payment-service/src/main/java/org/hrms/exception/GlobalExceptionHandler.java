...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AdvancePaymentManagerException.class)
    public ResponseEntity<ErrorMessage> handleMovieAppException(AdvancePaymentManagerException exception) {

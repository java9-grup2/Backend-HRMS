...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UpcomingPaymentManagerException.class)
    public ResponseEntity<ErrorMessage> handleMovieAppException(UpcomingPaymentManagerException exception) {

...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FinancialPerformanceException.class)
    public ResponseEntity<ErrorMessage> handleMovieAppException(FinancialPerformanceException exception) {

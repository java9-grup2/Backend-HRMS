...
public enum ErrorType {
    ...
    NOT_PENDING_APPROVAL(12325,"Bekleyen bir onaylama istegi yok.",HttpStatus.BAD_REQUEST),
    COMPANY_NAME_MISMATCH(12325,"Sirket ismi uyusmuyor.",HttpStatus.BAD_REQUEST);
